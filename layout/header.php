...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="admin/img/<?php echo $settings['logo'] ?>">
    <!-- CSS here -->
                ...
                <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo logo">
                        <a href="trang-chu.html">
                            <img width="70px" height="55px" src="admin/img/<?php echo $settings['logo'] ?>" alt="logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                            <div class="logo">
                                <a href="trang-chu.html">
                                    <img width="110px" height="75px" src="admin/img/<?php echo $settings['logo'] ?>" alt="logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                            <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                ...
                                <div class="tp-header-action d-flex align-items-center ml-50">
                                    ...
                                    <div class="tp-header-action-item d-none d-lg-block">
                                        <a href="?mod=wishlist&action=main" class="tp-header-action-btn">
                                            ...
                                            <span class="tp-header-action-badge count_wishlist"><?php echo (isset($_SESSION['wishlist'])) ? count($_SESSION['wishlist']) : "0" ?></span>
                                        </a>
                                    </div>
                                ...
                                <div class="main-menu menu-style-1">
                                    <nav class="tp-main-menu-content">
                                        <ul>
                                            ...
                                            <!-- <li><a href="?mod=wishlist&action=main">Khuyễn mại</a></li> -->
                                        </ul>
                                    </nav>
                                </div>
                            </div>
            ...
            <div class="tp-mega-menu-wrapper p-relative">
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                        <div class="logo">
                            <a href="trang-chu.html">
                                <img width="70px" height="50px" src="admin/img/<?php echo $settings['logo'] ?>" alt="logo">
                            </a>
                        </div>
                    </div>
