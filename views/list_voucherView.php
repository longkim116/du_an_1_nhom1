...
<div class="content-wrapper">
    <div class="card">
        ...
        <div class="breadcrumb">
            <li class="breadcrumb-item"><a href="?mod=slider&action=list_slider" class="text-decoration-none">Tất cả(<?php echo count($list_voucher) ?>)</a></li>
        </div>
        <!-- /.card-header -->
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $item['vouchers'] ?></td>
                                    <td class="text-danger"><?php echo currency_format($item['price']) ?></td>
                                    <td><?php echo $item['creator'] ?></td>
                                    <td><?php echo $item['date_created'] ?></td>
                                    <td>
                                        <a href="?mod=voucher&action=update_voucher&id=<?php echo $item['id'] ?>" title="Sửa"><img src="public/img/pen (1).png" alt=""></a>
                                        <a onclick="return confirm('Bạn chắc muốn xóa không')" href="?mod=voucher&action=delete_voucher&id=<?php echo $item['id'] ?>" title="Xóa"><img src="public/img/delete1.png" alt=""></a>
                                    </td>
                                </tr>
                            <?php endforeach;
                        else : ?>
                            <td colspan="7">Không có mã voucher nào</td>
                        <?php
                        endif; ?>
                    </tbody>
                </table>
