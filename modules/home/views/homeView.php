            ...
            <div class="row align-items-end">
                <div class="col-xl-5 col-lg-6 col-md-5">
                    <div class="tp-section-title-wrapper mb-40">
                        <h3 class="tp-section-title">Sản phẩm khuyễn mãi
                    ...
                    <div class="tp-product-tab tp-product-tab-border mb-45 tp-tab d-flex justify-content-md-end">
                        <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="new-tab" data-bs-toggle="tab" data-bs-target="#new-tab-pane" type="button" role="tab" aria-controls="new-tab-pane" aria-selected="true">Khuyễn mãi
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="featured-tab" data-bs-toggle="tab" data-bs-target="#featured-tab-pane" type="button" role="tab" aria-controls="featured-tab-pane" aria-selected="false">Bán chạy
                                    <span class="tp-product-tab-line">
                                        <svg width="52" height="13" viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" stroke-width="2" stroke-miterlimit="3.8637" stroke-linecap="round" />
                                        </svg>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="topsell-tab" data-bs-toggle="tab" data-bs-target="#topsell-tab-pane" type="button" role="tab" aria-controls="topsell-tab-pane" aria-selected="false">New
                                    <span class="tp-product-tab-line">
                                        <svg width="52" height="13" viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" stroke-width="2" stroke-miterlimit="3.8637" stroke-linecap="round" />
                                        </svg>
                                            ...
                                            <div class="tp-product-item p-relative transition-3 mb-25">
                                                ...
                                                <div class="tp-product-content">
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <span class="tp-product-price new-price"><?php echo currency_format(min_price($item['product_id'])) ?></span> -
                                                        <span class="tp-product-price new-price"><?php echo currency_format(max_price($item['product_id'])) ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    function by_now(_this) {
        ...
        if (id_color == null) {
            ...
            window.location.href = "?mod=cart&action=checkout&buy_now=" + id_color + "&quantity=" + quantity;
        }
    }
</script>
<?php
