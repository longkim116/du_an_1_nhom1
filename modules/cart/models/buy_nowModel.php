...
function checkout_momo($total_price) //Thanh toán bằng momo
{
    ...
    $amount = $total_price;
    $orderId = time() . "";
    $redirectUrl = "http://localhost/Du-an-1/autosmart/?mod=cart&controller=buy_now&action=success_buy_now";
    $ipnUrl = "http://localhost/Du-an-1/autosmart/?mod=cart&controller=buy_now&action=success_buy_now";
    $extraData = "";
