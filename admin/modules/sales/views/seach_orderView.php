...
<div class="content-wrapper">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">DANH SÁCH TÌM KIẾM ĐƠN HÀNG</h3>
        </div>
        ...
        <div class="card-body p-0">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php if (!empty($list_order_seach)) :
                        $count = 0;
                        foreach ($list_order_seach as $item) :
                    ?>
                            <tr>
                        ...
                        <td class="text-center" colspan="9">Không tìm thấy đơn hàng</td>
                    <?php endif; ?>
                </tbody>
            </table>
            </form>
